...
const port = process.env.SERVER_PORT || process.env.PORT || 3010;        
const UUID = process.env.UUID || '986e0d08-b275-4dd3-9e75-f30ohj36fa2a'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';     
const NEZHA_PORT = process.env.NEZHA_PORT || '5555';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'c.fafa888.filegear-sg.me';     // 建议使用token，argo端口8081，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZWU4NWQ5YmQwNTI0OThhNmIwNWY0N2NjZmQ1YjM1MzIiLCJ0IjoiZjc1ZGE4OGMtNmVkMy00NzIwLTlkMjItYzkxMzE3YTIyNjU3IiwicyI6IlpEWmpNelJtT0RFdE5XTTFaUzAwWkdObUxUZ3hNVFF0TmpCbE5XRmtaamRoTm1KaiJ9';
